        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 d-flex flex-column gap-3 mb-3">
                <div class="d-flex flex-column gap-1">
                    ...
                    <input type="text" id="male_name" value="{{ $data->male_name }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Nama Panggilan Pria</label>
                    <input type="text" id="male_alias" value="{{ $data->male_nickname }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Nama Bapak Pria</label>
                    <input type="text" id="male_father" value="{{ $data->male_father_name }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Nama Ibu Pria</label>
                    <input type="text" id="male_mother" value="{{ $data->male_mother_name }}" class="form-control" autocomplete="off">
                </div>
            </div>
            <div class="col-md-6 col-sm-12 d-flex flex-column gap-3 mb-3">
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Nama Lengkap Wanita</label>
                    <input type="text" id="female_name" value="{{ $data->female_name }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Nama Panggilan Wanita</label>
                    <input type="text" id="female_alias" value="{{ $data->female_nickname }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Nama Bapak Wanita</label>
                    <input type="text" id="female_father" value="{{ $data->female_father_name }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Nama Ibu Wanita</label>
                    <input type="text" id="female_mother" value="{{ $data->female_mother_name }}" class="form-control" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="d-flex gap-3 mb-3">
                    <div class="d-flex flex-column gap-1 w-100">
                        ...
                        <input type="text" id="akad_date" value="{{ explode(" ", $data->akad_date)[0] }}" class="form-control" autocomplete="off" placeholder="YYYY-MM-DD">
                    </div>
                    <div class="d-flex flex-column gap-1 w-100">
                        <label for="" class="fw-semibold">Waktu Akad</label>
                        <input type="text" id="akad_time" value="{{ explode(" ", $data->akad_date)[1] }}" class="form-control" autocomplete="off" placeholder="HH:MM">
                    </div>
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Tempat/Alamat Akad</label>
                    <textarea name="" id="akad_place" cols="30" rows="5" class="form-control" autocomplete="off">{{ $data->akad_place }}</textarea>
                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="d-flex gap-3 mb-3">
                    <div class="d-flex flex-column gap-1 w-100">
                        ...
                        <input type="text" id="resepsi_date" value="{{ explode(" ", $data->resepsi_date)[0] }}" class="form-control" autocomplete="off" placeholder="YYYY-MM-DD">
                    </div>
                    <div class="d-flex flex-column gap-1 w-100">
                        <label for="" class="fw-semibold">Waktu Resepsi</label>
                        <input type="text" id="resepsi_time" value="{{ explode(" ", $data->resepsi_date)[1] }}" class="form-control" autocomplete="off" placeholder="HH:MM">
                    </div>
                </div>
                <div class="d-flex flex-column gap-1 mb-3">
                    <label for="" class="fw-semibold">Tempat/Alamat Resepsi</label>
                    <textarea name="" id="resepsi_place" cols="30" rows="5" class="form-control" autocomplete="off">{{ $data->resepsi_place }}</textarea>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-sm-12 d-flex flex-column gap-3 mb-3">
                <div class="d-flex flex-column gap-1">
                    ...
                    <input type="text" id="male_contact" value="{{ $data->male_contact }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Akun Instagram Pria</label>
                    <input type="text" id="male_ig" value="{{ $data->male_ig }}" class="form-control" autocomplete="off">
                </div>
            </div>
            <div class="col-md-6 col-sm-12 d-flex flex-column gap-3 mb-3">
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">No. Whatsapp Wanita</label>
                    <input type="text" id="female_contact" value="{{ $data->female_contact }}" class="form-control" autocomplete="off">
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="" class="fw-semibold">Akun Instagram Wanita</label>
                    <input type="text" id="female_ig" value="{{ $data->female_ig }}" class="form-control" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12 d-flex flex-column gap-3 mb-3">
                <div class="d-flex flex-column gap-1">
                    ...
                    <input type="text" id="backsound_link" value="{{ $data->backsound_link }}" class="form-control" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="row">
...
<script>
    ...
    $("#submit").click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "/admin/pengguna/update/{{ $data->id }}",
            type: "PUT",
            data: {
                _token: "{{ csrf_token() }}",
